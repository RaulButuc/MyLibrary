...
template <class _Tp>
forward_list_iterator<_Tp>::forward_list_iterator(forward_list_node<_Tp>* _node) : m_pNode(_node) {}
...
template <class _Tp>
const typename forward_list_iterator<_Tp>::iterator& forward_list_iterator<_Tp>::operator+=(int _num) {
...
template <class _Tp>
bool forward_list_iterator<_Tp>::operator==(const typename forward_list_iterator<_Tp>::iterator& _position) const {
